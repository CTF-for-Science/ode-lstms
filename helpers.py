...
def load_dataset_trainer(args):
    if args.dataset == "person":
        ...
        batch_size = 64
    elif args.dataset in ["ODE_Lorenz", "PDE_KS", "Lorenz_Official", "KS_Official", "seismo"]:
    ...
    num_classes = train_x.shape[2] if args.dataset in ["ODE_Lorenz", "PDE_KS", "KS_Official", "Lorenz_Official", "seismo"] else int(torch.max(train_y).item() + 1)
